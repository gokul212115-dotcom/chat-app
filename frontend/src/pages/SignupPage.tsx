...
export default function SignupPage() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-black overflow-hidden px-4">
      ...
      <div className="absolute -top-32 -right-32 w-96 h-96 bg-teal-500/30 rounded-full blur-3xl animate-float" />
      <div className="absolute -bottom-32 -left-32 w-96 h-96 bg-emerald-500/30 rounded-full blur-3xl animate-floatSlow" />
      <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-teal-400/20 rounded-full blur-3xl animate-glow" />
      ...
      <div className="relative z-10 w-full max-w-sm bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl p-8 animate-fadeInUp">
        ...
        <p className="text-gray-400 mb-6 text-sm">Join and start chatting</p>
